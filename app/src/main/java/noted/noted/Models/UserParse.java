...
public class UserParse {
    ...
    public static void userLogIn(User user, final Model.SimpleSuccessListener listener) {
    ...
    public static void userSignUp(User user, final Model.SimpleSuccessListener listener) {
    ...
    public static void userLogOut(final Model.SimpleSuccessListener listener) {
